    ...
    <div>
        <div className="border-end d-none d-lg-block h-100" style={{width:'200px'}}>
            <div className="d-flex flex-column sidebar">
                ...
                <Link to="/Recruiter_dashboard" className=" p-3 ps-3 text-decoration-none text-dark" href="#">Dashboard</Link>
                ...
                <ul className="collapse ps-3" id="candidates">
                  <li className='sidebar_dropdown'>
                    <Link to="/Recruiter_general_form_records" className='text-decoration-none text-dark'><i class="fa-solid fa-caret-up fa-rotate-90 me-1"></i>General Form Records</Link>
                  </li>
                  <li className='sidebar_dropdown'>
                    <Link to="/Recruiter_candidate_records" className='text-decoration-none text-dark'><i class="fa-solid fa-caret-up fa-rotate-90 me-1"></i>Candidates</Link>
                  </li>
                </ul>
                ...
                <ul className="collapse ps-3" id="requirements">
                  <li className='sidebar_dropdown'>
                    <Link to="/Recruiter_active_requirements" className='text-decoration-none text-dark '><i class="fa-solid fa-caret-up fa-rotate-90 me-1"></i>Active</Link>
                  </li>
                ...
                <ul className="collapse ps-3" id="live_interviews">
                  <li className='sidebar_dropdown'>
                    <Link to="/Recruiter_live_interviews_self" className='text-decoration-none text-primary'><i class="fa-solid fa-caret-up fa-rotate-90 me-1"></i>Self</Link>
                  </li>
                  <li className='sidebar_dropdown  mt-1'>
                   <Link to="/Recruiter_live_interviews_client" className='text-decoration-none text-primary'> <i class="fa-solid fa-caret-up fa-rotate-90 me-1"></i>Client</Link>
                  </li>
                  </ul>
                  </li>
                  <li className='sidebar_dropdown mt-1'>
