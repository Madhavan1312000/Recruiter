...
import General_screening_form from './Forms/General_screening_form'
import Interview_Forms from './Forms/Interview_Forms'
import Group_discussion_form from './Forms/Group_discussion_form'
import Face_to_face_form from './Forms/Face_to_face_form'
  ...
  return (
    <div>
        ...
        <div className="d-flex main-container">
            <Sidebar></Sidebar>
            <div className="w-100 p-3 bg-white h-100">
