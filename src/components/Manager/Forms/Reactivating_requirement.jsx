...
const Reactivating_requirement = () => {
  return (
    <div>
       <div class="modal modal-lg fade" id="reactivate_requirement" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel"
        aria-hidden="true">
...
export default Reactivating_requirement