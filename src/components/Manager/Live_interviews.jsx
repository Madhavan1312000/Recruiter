  ...
  return (
    <div>
        ...
        <div className="d-flex main-container">
          ...
          <div className="">
            <h6 className="text-black">Live Interviews - <span className='text-primary'>Self</span></h6>
          </div>
...
<div className="d-flex justify-content-between mt-3">
            ...
            <Link to="/candidate_wise_tables" className="text-white bg-primary btn btn-sm">
              View Candidate Wise
            </Link>
          </div>
            ...
            <table class="table table-hover border">
              ...
              <tbody>
                <tr style={{ fontSize: "15px" }}>
                  ...
                  <td>1 Year</td>
                  <td>Written Test</td>
                  <td><Link to="/attendpage"><button className='btn btn-sm btn-primary text-white'>Attend</button></Link></td>
                </tr>
                <tr style={{ fontSize: "15px" }}>
                  <td>Raja</td>
                  <td>BE</td>
...
export default Live_interviews